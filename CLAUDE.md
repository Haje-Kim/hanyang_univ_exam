...
| 2026-06-12 | medical-dx-ai 확장: ① 객관식 보기 클릭 시 자동 채점(정답✓/내 선택 배지)+정답·해설 자동 펼침 ② 주차별 핵심개념 A4 3p 서술(.cdeep, 안될공학식 빌드업·영어 병기, lecture-notes C1~C20 근거) ③ 예상문제 주차당 2세트(세트1/2 탭, 신규 40문항). adversarial-review 2회전(CNN permute 표현·WHO 6원칙·anti-aliasing 톤다운·모바일 가로 오버플로 수정) | medical-dx-ai.html | "정답 클릭 자동 펼침·핵심개념 주차별 확장·예상문제 2세트·검증 후 배포" 요청 |
| 2026-06-12 | medical-dx-ai 예상문제 전면 재설계: core↔세트1↔세트2 중복 제거 + 난이도 분리(세트1=응용·구분 중급 / 세트2=혼동행렬·파라미터·CNN 출력 계산형·통합비교·"옳지 않은 것 모두"·함정 고급). 주차 간 경계 정리(Week1 교차검증, Week4 P4) | medical-dx-ai.html | "각 주차 문제가 너무 겹침 — 겹치지 않게, 세트2 난이도↑" 요청 |
